...
export async function runProfile(
  ...
  // The shipped preset roster lives beside the dsh package and is a launcher fact.
  // Patch it exactly at the profile boundary instead of asking users to install it.

...
.dshDesktopMacCaptionRow { position: relative; grid-column: 2 / -1; grid-row: 1; min-width: 0; background: var(--dsw-alias-bg-base); border-bottom: 1px solid color-mix(in srgb, var(--avti-accent) 18%, transparent); }
...
.dshDesktopWindowsCaptionRow { position: relative; grid-column: 2 / -1; grid-row: 1; min-width: 0; background: var(--dsw-alias-bg-base); border-bottom: 1px solid color-mix(in srgb, var(--avti-accent) 18%, transparent); }
...
.dshDesktopResizeHandle:hover { background: color-mix(in srgb, var(--avti-accent) 28%, transparent); }
...
@media (prefers-color-scheme: light) {
  body[data-dsh-desktop-mode="advanced"] { background: var(--avti-bg) !important; }
  .dshDesktopSidebarSurface { background: var(--avti-surface); border-right-color: var(--avti-border); box-shadow: 1px 0 0 rgba(11, 17, 32, 0.02); }
  .dshDesktopConversationSurface,
  .dshDesktopMacCaptionRow,
  .dshDesktopWindowsCaptionRow { background: var(--avti-bg); }
  .dshDesktopDetailsSurface { background: var(--avti-surface); border-left-color: var(--avti-border); }
}
